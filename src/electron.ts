...
// TODO: Figure out how to manage environment variables in electron apps.
...
console.log(
  '\x1b[33m\x1b[40m%s\x1b[0m',
  `\n===== [DEBUG] ===== Debugging dayjs ===== [DEBUG] =====`,
)
console.log(dayjs.duration({ days: 1 }).asMinutes())
console.log(
  '\x1b[33m\x1b[40m%s\x1b[0m',
  `===== [DEBUG] ===== Debugging dayjs ===== [DEBUG] =====\n`,
)

// TODO: This should probably be moved to some kind of config service later.
...
app.whenReady().then(async () => {
  ...
  ipcMain.handle(CONTEXT_BRIDGE_EVENT_NAMES.OPEN_DIRECTORY_PICKER, async (event) => {
    ...
    console.debug(
      '\x1b[33m\x1b[40m%s\x1b[0m',
      `\n===== [DEBUG] ===== Result in electron process ===== [DEBUG] =====`,
    )
